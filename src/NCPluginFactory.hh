#ifndef NCPlugin_CrystallineExtinctionFactory_hh
#define NCPlugin_CrystallineExtinctionFactory_hh
...
namespace NCPluginNamespace {
  ...
  class CrystallineExtinctionFactory final : public NC::FactImpl::ScatterFactory {
  public:
