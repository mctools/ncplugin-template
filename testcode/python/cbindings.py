...
def _setuptestlibhooks():
    ...
    f.restype = None # void
    f.argtypes = [ ctypes.c_int, ctypes.c_double,  ctypes.c_double,ctypes.c_double, ctypes.c_double, ctypes.c_double, ctypes.c_double, ctypes.c_double, ctypes.c_uint, npdoubleptr ]
    ...
    f.restype = None # void
    f.argtypes = [ ctypes.c_int,ctypes.c_double, ctypes.c_double,  ctypes.c_double,ctypes.c_double, ctypes.c_double, ctypes.c_double,ctypes.c_uint, npdoubleptr, npdoubleptr ]
