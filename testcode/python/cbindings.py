...
def _setuptestlibhooks():
    ...
    f.restype = None # void
    #f.argtypes = [ ctypes.c_char_p, ctypes.c_double,  ctypes.c_double,ctypes.c_double, ctypes.c_double, ctypes.c_double, ctypes.c_double, ctypes.c_uint, npdoubleptr ]
    f.argtypes = [ ctypes.c_char_p, ctypes.c_double, ctypes.c_uint, npdoubleptr ]
    hooks['samplemanyscatmu'] = f

    f = lib.nctest_getmanyxsvalues
    f.restype = None # void
    #f.argtypes = [ ctypes.c_char_p,ctypes.c_double, ctypes.c_double,  ctypes.c_double,ctypes.c_double, ctypes.c_double, ctypes.c_uint, npdoubleptr, npdoubleptr ]
