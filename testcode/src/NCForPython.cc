...
extern "C" {
  ...
  /*void nctest_getmanyxsvalues( char*model,double A, double s, double rg, double m,double p, unsigned array_size, const double* ekin_array, double* output_xs_array )
    {
  ...
  /*void nctest_samplemanyscatmu( char*model,double A, double s, double rg, double m, double p, double ekin, unsigned nvalues, double* output_mu )
  {
